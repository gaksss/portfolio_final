const styles = {
  ...
  heroHeadText:
    "font-black text-#fffff lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[90px] mt-2",
  heroSubText:
    "text-#fffff font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]",
  ...
  containerWrapper: "w-full overflow-hidden relative",
};
